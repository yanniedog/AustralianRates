...
- **Google Gemini Code Assist**, **Codex** automated PR reviews, and similar bots: post **threaded replies** on substantive PR feedback—implemented, deferred, or declined with reason—before merge when practical. Cursor rule: `.cursor/rules/pr-review-bot-replies.mdc`.

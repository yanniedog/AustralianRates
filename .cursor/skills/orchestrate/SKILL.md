...
- **Future project development manager and planner** – Owns medium- and long-term product and technical roadmap; identifies future features, dependencies, and sequencing; plans capacity and phasing; aligns next-phase work with business and technical strategy; maintains future backlog and pipeline visibility.
...
- **future-development-manager**: Future project development manager and planner. Owns medium- and long-term product and technical roadmap; identifies future features, dependencies, and sequencing; plans capacity and phasing; aligns next-phase work with business and technical strategy; maintains future backlog and pipeline visibility. Delegate via generalPurpose when the task involves future roadmap, pipeline planning, phasing, dependencies, or strategic sequencing beyond the current sprint or critique.

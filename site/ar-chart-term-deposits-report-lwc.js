/**
 * Term deposit rate report — ECharts ribbon (min–max bands per institution). RBA + CPI via chartReportPlot.
 */
(function () {
    'use strict';
    window.AR = window.AR || {};
    ...
    function bankColor(name, idx) {
        ...
        var lead = u && typeof u.resolveSectionRibbonAccentHex === 'function' ? u.resolveSectionRibbonAccentHex() : '#f59e0b';

    ...
    function buildTimeRibbonOption(tr, fields, size) {
        ...
        return {
            ...
            yAxis: {
                ...
                axisLine: gridStyles().axisLine,
                splitLine: gridStyles().splitLine,
                axisLabel: { color: theme.softText, formatter: function (v) { return metricAxisLabel(fields.yField, v, narrow); } },
            },
            series: series,
        };
    }
    ...
    function buildTdTermTimeOption(tt, fields, size) {
        ...
        for (var i = 0; i < termCount; i++) {
            ...
            yAxes.push({
                ...
                axisLabel: { color: theme.softText, fontSize: 9, formatter: function (v) { return metricAxisLabel(fields.yField, v, true); } },
            });
        }
        var series = [];

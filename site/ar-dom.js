(function () {
    ...
    var els = {
        ...
        historicalPullEnabled: document.getElementById('historical-pull-enabled'),
        historicalStartDate: document.getElementById('historical-start-date'),
        historicalEndDate: document.getElementById('historical-end-date'),
        historicalWorkerHint: document.getElementById('historical-worker-hint'),

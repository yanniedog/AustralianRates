(function () {
    ...
    var els = {
        ...
        chartTimeSliderWrap: document.getElementById('chart-time-slider-wrap'),
        chartTimeSlider: document.getElementById('chart-time-slider'),
        chartTimeSliderDate: document.getElementById('chart-time-slider-date'),
        chartTimePlay: document.getElementById('chart-time-play'),

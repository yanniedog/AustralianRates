                ...
                '<aside class="terminal-column terminal-column-left">',
                    ...
                    '<section id="scenario" class="panel terminal-panel terminal-filter-panel">',
                        ...
                        '<div class="terminal-filter-grid terminal-filter-grid-primary">',
                            '<label class="terminal-field terminal-field-bank" data-help="Search and select one or more institutions." data-help-label="Banks">',
                                ...
                                '<div class="terminal-inline-inputs">',
                                    '<input id="filter-bank-search" type="search" placeholder="Search banks">',
                        ...
                        '<div class="terminal-action-row">',
                            '<button id="apply-filters" class="primary" type="button" data-help="Refresh the current slice across the dashboard." data-help-label="Apply filters">' + iconText('apply', 'Apply filters', 'control-chip-label') + '</button>',
                            '<button id="reset-filters" class="secondary" type="button" data-help="Reset the current slice to defaults." data-help-label="Reset filters">' + iconText('reset', 'Reset filters', 'control-chip-label') + '</button>',
                            '<button id="workspace-copy-link" class="secondary" type="button" data-help="Copy the current route, filters, pane, and hash state." data-help-label="Copy link">' + iconText('link', 'Copy link', 'control-chip-label') + '</button>',
                        '</div>',
                ...
                '<section class="terminal-column terminal-column-center">',
                    ...
                    '<section class="panel terminal-panel terminal-bottom-panel" id="table">',
                        ...
                        '<section id="panel-pivot" class="tab-panel" role="tabpanel" aria-labelledby="tab-pivot" hidden>',
                            '<div id="pivot">',
                                '<div class="terminal-data-head">',
                                    '<div>' + panelIcon('pivot', 'Pivot') + '<h2>Pivot workspace</h2></div>',
                                    '<div class="terminal-data-actions"><button id="load-pivot" type="button" class="secondary" data-help="Load rows into the pivot workspace." data-help-label="Load data">' + iconText('download', 'Load data', 'control-chip-label') + '</button></div>',
                                '</div>',
                                '<p id="pivot-status" class="hint">Ready to load</p>',

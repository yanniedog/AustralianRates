(function () {
    ...
    var statusHelpersFactory = window.AR && window.AR.AdminStatusPageHelpers && typeof window.AR.AdminStatusPageHelpers.create === 'function'
        ? window.AR.AdminStatusPageHelpers.create
        : null;
    if (!statusHelpersFactory) throw new Error('AdminStatusPageHelpers not loaded');
    var statusHelpers = statusHelpersFactory({
        copiedPayloadFingerprints: copiedPayloadFingerprints,
        payloadViewerEl: payloadViewerEl,
        payloadViewerStatusEl: payloadViewerStatusEl,
    });
    var esc = statusHelpers.esc;
    var clipboardIconHtml = statusHelpers.clipboardIconHtml;
    var payloadFingerprintFromText = statusHelpers.payloadFingerprintFromText;
    var payloadFingerprintFromButton = statusHelpers.payloadFingerprintFromButton;
    var payloadViewerFingerprint = statusHelpers.payloadViewerFingerprint;
    var setCopiedIconState = statusHelpers.setCopiedIconState;
    var syncCopiedPayloadButtons = statusHelpers.syncCopiedPayloadButtons;
    var copyPayloadFromDetailsButton = statusHelpers.copyPayloadFromDetailsButton;
    var isPayloadViewerCopyable = statusHelpers.isPayloadViewerCopyable;
    var updatePayloadViewerCopyButtonState = statusHelpers.updatePayloadViewerCopyButtonState;
    var copyPayloadViewerToClipboard = statusHelpers.copyPayloadViewerToClipboard;
    var boolPill = statusHelpers.boolPill;
    var statusPillHtml = statusHelpers.statusPillHtml;
    var rowSeverityCoverageGap = statusHelpers.rowSeverityCoverageGap;
    var rowSeverityLenderUniverse = statusHelpers.rowSeverityLenderUniverse;
    var rowSeverityReplayQueue = statusHelpers.rowSeverityReplayQueue;
    var rowSeverityHistory = statusHelpers.rowSeverityHistory;
    var severityToRowFilterAttr = statusHelpers.severityToRowFilterAttr;
    var boolToRowFilterAttr = statusHelpers.boolToRowFilterAttr;
    var cdrCheckRowFilterAttr = statusHelpers.cdrCheckRowFilterAttr;
    var severityFromComponents = statusHelpers.severityFromComponents;
    var severityFromIntegrityChecks = statusHelpers.severityFromIntegrityChecks;
    var severityFromHistoryList = statusHelpers.severityFromHistoryList;
    var coverageGapRemediationScope = statusHelpers.coverageGapRemediationScope;
    var replayRowDiagnosticObject = statusHelpers.replayRowDiagnosticObject;
    var diagnosticCell = statusHelpers.diagnosticCell;
    var severityFromOverall = statusHelpers.severityFromOverall;
    var severityFromE2E = statusHelpers.severityFromE2E;
    var severityFromIssueCount = statusHelpers.severityFromIssueCount;
    var severityFromCdrReport = statusHelpers.severityFromCdrReport;
    var severityFromGapCount = statusHelpers.severityFromGapCount;
    var severityFromLenderUniverse = statusHelpers.severityFromLenderUniverse;
    var severityFromReplayQueue = statusHelpers.severityFromReplayQueue;
    var severityFromProbePayloads = statusHelpers.severityFromProbePayloads;
    var severityFromEconomic = statusHelpers.severityFromEconomic;
    var applyCardSeverity = statusHelpers.applyCardSeverity;
    var setStatusLineSeverity = statusHelpers.setStatusLineSeverity;
    var cardCell = statusHelpers.cardCell;
    var datasetLabel = statusHelpers.datasetLabel;
    var eventAction = statusHelpers.eventAction;
    var eventActions = statusHelpers.eventActions;
    var maybeJson = statusHelpers.maybeJson;
    var severityFromStoredAuditLatest = statusHelpers.severityFromStoredAuditLatest;
    var trafficClassStored = statusHelpers.trafficClassStored;
    var trafficLabelStored = statusHelpers.trafficLabelStored;

...
**Automated PR reviews:** After each PR push, **wait** for bot reviewers (typically a few minutes; they may trail in separately), **re-check** the PR for new comments, **then** give the user a final bot-feedback summary or apply fixes. You may do other work in the meantime and answer later. Full wording: **`AGENTS.md`** (multiagent / CI bullet) and **`.cursor/rules/multiagent-modularity.mdc`** (“Respond to CI feedback”).

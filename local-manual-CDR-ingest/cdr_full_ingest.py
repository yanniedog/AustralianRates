...
Exit codes: 0 success; 1 no holders matched ``--holders`` (register OK); 2 register failure, zero brands for enabled sector(s) without filter waiver, or a parallel holder worker raised an exception.

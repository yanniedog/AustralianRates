...
/** Exported for slice-pair stats (universe must match `queryLatestSavingsRatesCount`). */
export function buildLatestWhere(filters: LatestSavingsFilters): { clause: string; binds: Array<string | number> } {
  const where: string[] = []
